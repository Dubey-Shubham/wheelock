            ...
            <Box sx={{ flexGrow: 1, height: "90px" }}>
                <AppBar elevation={1} position="fixed" sx={{ height: "90px", justifyContent: "center", backgroundColor: "white", zIndex: (theme) => theme.zIndex.drawer + 1 }}>
                    <Toolbar variant="regular">
                        ...
                        <IconButton edge="start" color="inherit" aria-label="menu" sx={{ '@media (max-width: 1000px)': { display: "none" },mr: 2, position: "absolute", top: "11px", right: "160px" }}>
                            <Box sx={{ height: "32px", width: "32px", backgroundColor: "rgb(223, 226, 234)", }}>
                                <NotificationsNoneOutlinedIcon sx={{ color: 'blue', alignItems: "center", marginTop: "3px" }} />
                            </Box>
                        </IconButton>
                        <IconButton edge="start" color="inherit" aria-label="menu" sx={{'@media (max-width: 1000px)': {right:"0px", mr: 1}, mr: 2, position: "absolute", top: "8x", right: "30px" }}>
                            <Box sx={{'@media (max-width: 1000px)': {height: "52px", width: "55px"}, height: "52px", width: "102px", backgroundColor: "rgb(223, 226, 234)", display: "flex", flex: "row", justifyContent: "center", gap: "20px", borderRadius: "30px" }}>
